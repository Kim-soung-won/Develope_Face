...
// 데이터 파일과 동적 아이콘 로더를 import 합니다.
import DynamicMuiIcon from '@/shared/ui/icon/dynamic-icon-loader' // 실제 경로에 맞게 수정
...
export function IconFinderPage({ iconNames, iconTags }: IconFinderPageProps) {
          ...
          <Grid container spacing={2}>
            {displayedIcons.map((iconName) => (
              ...
              <Grid size={2} key={iconName}>
                ...
                >
                  <DynamicMuiIcon iconName={iconName} sx={{ fontSize: 40 }} />
